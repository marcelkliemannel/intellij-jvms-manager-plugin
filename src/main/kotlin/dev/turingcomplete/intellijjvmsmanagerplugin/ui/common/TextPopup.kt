...
private constructor(
  content: String,
  softWrap: Boolean,
  private val breakCommandSupported: Boolean,
  ...
  companion object {
    ...
    fun showCenteredInCurrentWindow(
      ...
      create(content, softWrap, breakCommandSupported, breakCommand, title, wide)
  ...
  init {
    ...
    textAreaPanel =
      UiUtils.Panel.TextAreaPanel(content, softWrap, breakCommand).apply {
        var (width, height) =
          when {
  ...
  private fun createPopupToolbar(): JComponent {
    ...
    return ActionManager.getInstance()
      .createActionToolbar(
        "${JvmsManagerToolWindowFactory.TOOLBAR_PLACE_PREFIX}.toolbar.textPopup",
        toolbarGroup,
        false,
      )
      .run {
